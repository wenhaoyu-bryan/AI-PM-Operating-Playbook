  ...
  workbench: {
    ...
    stepTitles: {
      ...
      design: {
        ...
        agentApproachRationale: { en: 'Approach rationale', zh: '方案理由' },
        tools: { en: 'Tools', zh: '工具' },
        workflowSteps: { en: 'Workflow steps', zh: '工作流步骤' },
        autonomyBoundary: { en: 'Autonomy boundary', zh: '自主性边界' },
        executionBoundary: { en: 'Execution Boundary', zh: '执行边界' },
        workflowBoundary: { en: 'Workflow Boundary', zh: '工作流边界' },
        ...
        agentApproachRationaleHint: { en: 'Why is this approach the right one?', zh: '为什么这个方案是正确的？' },
        ...
        executionBoundaryHint: { en: 'Where does automated execution end and human work begin?', zh: '自动化执行在哪里结束，人工在哪里开始？' },
        workflowBoundaryHint: { en: 'Define the boundary for this workflow regardless of implementation pattern.', zh: '无论实现模式如何，定义此工作流的边界。' },
        humanReviewHint: { en: 'Where does a human need to review or approve?', zh: '哪里需要人工审核或批准？' },
        humanReviewHintAgent: { en: 'Which decisions or actions require explicit human approval?', zh: '哪些决策或操作需要明确的人工批准？' },
        humanReviewHintDeterministic: { en: 'Which low-confidence outputs, exceptions, or high-impact results require manual review?', zh: '哪些低置信度输出、异常或高影响结果需要人工审核？' },
        humanReviewHintUnsure: { en: 'Where should a human review the workflow regardless of the final implementation pattern?', zh: '无论最终实现模式如何，哪些环节需要人工审核？' },
        ...
        agentUnsureButton: { en: 'Not sure', zh: '暂不确定' },
        ...
        agentDecisionUnsure: { en: 'Not sure yet', zh: '暂不确定' },
        ...
        workflowSpecLabel: { en: 'AI Workflow Specification', zh: 'AI 工作流规格说明' },
        agentWorkflowSpecLabel: { en: 'Agent Workflow Specification', zh: 'Agent 工作流规格说明' },
        approachRationale: { en: 'Approach rationale', zh: '方案理由' },
        approachRationaleHint: { en: 'Why is this the right approach?', zh: '为什么这是正确的方案？' },
    ...
    designReview: {
      title: { en: 'Design Review', zh: '设计检查' },
      subtitle: { en: 'Rule-based checks for common product-design gaps', zh: '基于规则的产品设计缺口检查' },
      noFindings: { en: 'No rule-based gaps detected.', zh: '当前未发现规则型缺口。' },
      noFindingsNote: { en: 'This does not mean the product is production-ready. Validate assumptions, technical feasibility, and business risk with the relevant team.', zh: '这并不表示产品已经具备生产上线条件，仍需由相关团队验证业务假设、技术可行性与风险。' },
      goToStep: { en: 'Go to step', zh: '跳转到步骤' },
      missing: { en: 'Missing', zh: '缺失' },
      warning: { en: 'Warning', zh: '警告' },
      suggestion: { en: 'Suggestion', zh: '建议' },
      missingCount: { en: 'missing', zh: '项缺失' },
      warningCount: { en: 'warning', zh: '项警告' },
      suggestionCount: { en: 'suggestion', zh: '项建议' },
      itemsToReview: { en: 'items to review', zh: '项需要关注' },
      disclaimer: { en: 'These findings are generated from deterministic rules and do not replace product, engineering, security, legal, or domain review.', zh: '这些结果由确定性规则生成，不能替代产品、工程、安全、法务或领域专家评审。' },
    },
    scenarios: {
      label: { en: 'Evaluation Scenarios', zh: '评估场景' },
      hint: { en: 'What concrete scenarios will you use to test whether the product works, fails safely, and handles edge cases?', zh: '你将使用哪些具体场景，验证产品是否有效、能否安全失败，以及能否处理边界情况？' },
      insertTemplate: { en: 'Insert scenario template', zh: '插入场景模板' },
      insertMissing: { en: 'Insert missing categories', zh: '插入缺失类别' },
      happyPath: { en: 'Happy path', zh: '正常流程场景' },
      edgeCase: { en: 'Edge case', zh: '边界场景' },
      failureCase: { en: 'Failure case', zh: '失败场景' },
      humanReview: { en: 'Human review case', zh: '人工审核场景' },
      misuseCase: { en: 'Misuse / boundary case', zh: '误用或越界场景' },
    },
    patterns: {
      title: { en: 'Product Pattern Guide', zh: '产品模式指南' },
      viewGuide: { en: 'View guide', zh: '查看指南' },
      hideGuide: { en: 'Hide guide', zh: '隐藏指南' },
      suitableFor: { en: 'Suitable for', zh: '适用于' },
      avoidWhen: { en: 'Avoid when', zh: '不适用于' },
      coreInputs: { en: 'Core inputs', zh: '核心输入' },
      keyEvaluations: { en: 'Key evaluations', zh: '关键评估' },
    },
  },
  homepage: {
