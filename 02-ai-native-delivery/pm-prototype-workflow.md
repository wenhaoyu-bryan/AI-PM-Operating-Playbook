...
**English** | **[中文](pm-prototype-workflow.zh-CN.md)**
...
## 参考竞品
- 竞品 A：Palantir AIP - 本体驱动的智能体界面
- 竞品 B：ServiceNow - 任务工单系统
...
| 阶段 | 传统方式 | AI Native | 提升 |
|------|----------|-----------|------|
| PRD 编写 | 2-3 天 | 20 min | 10x |
| 设计稿 | 3-5 天 | - | - |
| 前端开发 | 1-2 周 | 30 min | 20x |
